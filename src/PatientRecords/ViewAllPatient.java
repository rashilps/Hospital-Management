 ...
 * @author Rashi
 */
public class ViewAllPatient extends javax.swing.JPanel {
     ...
     */
    public ViewAllPatient(MainFrame parent) {
        initComponents();
        this.parent = parent;
        loadPatientData();
...
private void loadPatientData() {
    try {
        String sql = "SELECT patient_id, name, age, gender FROM patients";
        PreparedStatement pst = MyConnection.getConnection().prepareStatement(sql);
        ResultSet rs = pst.executeQuery();

        javax.swing.table.DefaultTableModel model = new javax.swing.table.DefaultTableModel(
            new String[]{"ID", "Full Name", "Age", "Gender"}, 0
        );
        ...
        jTable1.setModel(model);  // ✅ Change to your JTable variable
    ...
    private void initComponents() {
        ...
        jLabel3.setText("View all patient");
